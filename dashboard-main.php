...
<div class="lg:fixed lg:top-0 lg:right-0">
    ...
    <div class="flex flex-wrap items-start gap-5 lg:w-[93vw] m-3">
        ...
        <div class="md:flex lg:flex-col md:justify-around w-full lg:w-[20vw] lg:h-[45vh] overflow-hidden">
            <div class="lg:w-[20vw] lg:h-[22vh] md:w-[40vw] bg-white p-4 border border-gray-200 rounded-lg shadow-lg flex flex-col gap-3 mb-2">
        ...
        <!-- number of sessions -->
        <div class="flex gap-4 lg:flex-col lg:h-[47vh] lg:w-[20vw] md:justify-between w-full">
            <div class="h-1/2 bg-white py-4 px-5 md:w-[40vw] lg:w-[20vw] rounded-xl shadow-lg">
        ...
        <!-- Daily Progress -->
        <div class="w-full lg:w-[20vw] lg:h-[47vh] md:w-[60vw] p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
            <div class="text-xl md:text-3xl lg:text-3xl font-semibold text-center">Daily Progress</div>
            <div class="text-sm md:text-md text-center mt-2 mb-4">Keep improving the <br>quality of your study</div>
